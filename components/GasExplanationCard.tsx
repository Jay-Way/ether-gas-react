    ...
    return (
        <Card className=" mt-6">
            ...
            <CardBody>
                ...
                <Spacer y={8}/>
                <p className="text-large">The gas limit, multiplied by the current gas price results in the maximum cost of your tx. Keep in
                    mind that usually not all of the gas is used.</p>
                <Spacer y={8}/>
