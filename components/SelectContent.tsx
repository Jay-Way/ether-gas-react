...
export const layer2Items: Array<L2SelectItem> = [
    {value: 'arbitrum', label: 'Arbitrum', startContent: <Image alt="arb logo" radius="sm" src="https://cryptologos.cc/logos/arbitrum-arb-logo.svg?v=029" width={25} />},
    {value: 'optimism', label: 'Optimism', startContent: <Image alt="opt logo" radius="sm" src="https://cryptologos.cc/logos/optimism-ethereum-op-logo.svg?v=029" width={25} />},
]